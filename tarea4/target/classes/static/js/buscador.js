...
// Variables del selector de nota (aparece inline dentro de cada resultado)
var actividadActual = null;  // id de la actividad que se esta evaluando
var temporizador    = null;  // para el debounce

// -------------------------------------------------------
// Escuchar lo que escribe el usuario (igual al search-bar.js del profesor)
// -------------------------------------------------------
inputBuscar.addEventListener("input", function() {
    ...
    // Esperamos 350ms antes de llamar al servidor (debounce)
...
// -------------------------------------------------------
// Llamada fetch al servidor Spring Boot (igual al fetchAJAX del profesor)
// -------------------------------------------------------
var fetchBuscar = function(texto) {
    fetch("/api/buscar?texto=" + encodeURIComponent(texto))
...
// -------------------------------------------------------
// Resaltar el texto buscado con <mark>
// -------------------------------------------------------
...
// -------------------------------------------------------
// Mostrar/ocultar el selector de nota inline
// -------------------------------------------------------
...
function guardarNota(idActividad, botonConfirmar) {
    ...
    fetch("/api/actividades/" + idActividad + "/nota", {
        method: "POST",
