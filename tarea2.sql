-- Active: 1778509885778@@127.0.0.1@3306@mysql
...
-------------------------------------------
USE tarea2;
ALTER TABLE miembro ADD COLUMN tipo VARCHAR(50);
----------------------------------------------------
...
----------
USE tarea2;
ALTER TABLE actividad MODIFY COLUMN tipo ENUM(
    'artistica', 
    'deportiva', 
    'tecnologica/programacion', 
    'social/voluntariado', 
    'recreativa',
    'academica',
